...
const Sellcard = () => {
  return (
        ...
        <div className='relative flex  justify-between gap-6 w-96 lg:w-7xl lg:h-1/12 md:w-7xl md:h-1/12 sm:w-7xl sm:h-1/12 bg-white/10 backdrop-blur-lg border border-white/40 rounded-3xl text-white m-8 p-10' >
            <div>
                <img src={plantImg} alt="Plantain Lilies"  className='absolute -top-20 lg:-top-40 md:-top-40 sm:-top-40 -left-30 lg:left-1 md:-left-30 sm:-left-43 w-130 z-20'/>
            </div>
            <div className=' ml-32 lg:ml-0  md:ml-50 sm:ml-35'>
